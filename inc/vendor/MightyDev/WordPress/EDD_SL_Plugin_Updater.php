...
class EDD_SL_Plugin_Updater {
    ...
    public function init() {
        ...
        add_filter( 'pre_set_site_transient_update_plugins', array( $this, 'check_update' ), 0 );
        add_filter( 'plugins_api', array( $this, 'plugins_api_filter' ), 0, 3 );

        add_action( 'after_plugin_row_' . $this->name, array( $this, 'show_update_notification' ), 0, 2 );
    }
